  ...
  return(
    <>
      ...
      <div className="flex flex-col mx-auto gap-4">
         <div className="mx-auto p-4 bg-cyan-500 w-3/4 sm:w-1/2 md:w-1/4 h-auto rounded-lg hover:scale-105 transition-all duration-300 ease-in-out">
         ...
         <div className="mx-auto p-4 bg-rose-400 w-3/4 sm:w-1/2 md:w-1/4 h-auto rounded-lg hover:scale-105 transition-all duration-300 ease-in-out">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-4">
            <div className="mx-auto p-4 bg-amber-300 w-[80%] sm:w-[60%] md:w-full h-auto rounded-lg hover:scale-105 transition-all duration-300 ease-in-out">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-4">
            <div className="flex flex-col gap-4">
               <h1>Kelas I</h1>
               <div className="mx-auto p-4 bg-emerald-400 w-[80%] sm:w-[60%] lg:w-full h-auto rounded-lg hover:scale-105 transition-all duration-300 ease-in-out">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-4">
            {guruPJOK.map((item) => {
               return (
                  <div className="mx-auto p-4 bg-emerald-400 w-[80%] sm:w-[60%] md:w-full h-auto rounded-lg hover:scale-105 transition-all duration-300 ease-in-out">
                     <h1 className="text-blue-900 font-extrabold">{item.nama}</h1>
                     <hr className="text-blue-900" />
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-4">
            <div></div>
            <div className="mx-auto p-4 bg-orange-400 w-[80%] sm:w-[60%] md:w-full h-auto rounded-lg hover:scale-105 transition-all duration-300 ease-in-out">
         ...
         <div className="flex flex-col border mt-6 w-[80%] p-4 gap-y-4 h-auto mx-auto rounded-lg bg-white">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-2 text-xs">
               <div className="bg-cyan-500 py-2 rounded-lg">
                  <div className="w-2 h-2 rounded-full bg-blue-900 mx-auto "></div>
                  <h2 className="text-blue-900">Pimpinan</h2>
               </div>
               <div className="bg-rose-400 py-2 rounded-lg">
                  <div className="w-2 h-2 rounded-full bg-blue-900 mx-auto "></div>
                  <h2 className="text-blue-900">Wakil</h2>
               </div>
               <div className="bg-emerald-400 py-2 rounded-lg">
                  <div className="w-2 h-2 rounded-full bg-blue-900 mx-auto "></div>
                  <h2 className="text-blue-900">Guru</h2>
               </div>
               <div className="bg-amber-300 py-2 rounded-lg">
                  <div className="w-2 h-2 rounded-full bg-blue-900 mx-auto "></div>
                  <h2 className="text-blue-900">T. Pendukung</h2>
               </div>
               <div className="bg-lime-400 py-2 rounded-lg">
                  <div className="w-2 h-2 rounded-full bg-blue-900 mx-auto "></div>
                  <h2 className="text-blue-900">Komite</h2>
               </div>
               <div className="bg-orange-400 py-2 rounded-lg">
                  <div className="w-2 h-2 rounded-full bg-blue-900 mx-auto "></div>

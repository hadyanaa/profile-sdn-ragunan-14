               ...
               filteredData.map((item, index) => (
                  ...
                  >
                     <div className="relative h-64 overflow-hidden">
                        <img className="rounded-lg border h-full w-full" src={item.url_image ? convertDriveUrl(item.url_image, "thumbnail") : '/assets/image/agenda-no-image.png'} alt={item.peringkat} 

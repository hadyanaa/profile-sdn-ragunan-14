...
export default function Agenda() {
   const { agenda, loading, error, fetchAgenda } = useAppStore();
               ...
               filteredData.map((item, index) => (
                  ...
                  >
                     <div className="relative h-64 overflow-hidden">
                        <img className="rounded-lg border h-full w-full" src={item.foto ? item.foto : '/assets/image/agenda-no-image.png'} alt={item.peringkat} 
